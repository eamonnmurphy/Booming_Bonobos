...
# Script: TAutoCorr.R
# Desc: investigates autocorrelation in weather: are temperatures of one year correlated with the next year?
# Date: Oct 2021

## Calculate the correlation between n-1 pairs of years (n is total number of years)
